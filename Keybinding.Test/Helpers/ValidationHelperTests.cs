...
public class ValidationHelperTests
{
	...
	public void ThrowIfNullOrWhiteSpace_WithEmptyString_ThrowsArgumentException()
	{
		...
		Assert.Contains("cannot be null or whitespace", exception.Message, "Exception message should indicate null or whitespace error");
	}
	...
	public void ThrowIfNullOrWhiteSpace_WithCustomMessage_UsesCustomMessage()
	{
		...
		Assert.Contains(customMessage, exception.Message, "Exception message should contain the custom message");
	}
